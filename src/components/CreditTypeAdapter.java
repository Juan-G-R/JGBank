...
public class CreditTypeAdapter implements JsonDeserializer<Credit> {

    @Override
    public Credit deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        return new Credit(comment, identifier, balance, targetAccountNumber, effect, dateOfFlow);
    }
}